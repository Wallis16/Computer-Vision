...
#face_encoding_image_1 = face_recognition.face_encodings(image_1)[0]

# Load a second sample picture and learn how to recognize it.
image_2 = face_recognition.load_image_file("obama.jpg")
face_encoding_image_2 = face_recognition.face_encodings(image_2)[0]

#q = face_recognition.load_image_file("/home/default/Desktop/face_recognition_PDI/examples/DATA_SET_MV/"+"ID"+"-"+str(1)+".jpg")

image_3 = face_recognition.load_image_file("Bill.jpg")
face_encoding_image_3 = face_recognition.face_encodings(image_3)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
#	face_encoding_image_1,
	face_encoding_image_2,
	face_encoding_image_3
]
...
while True:
	...
	frame_aux = cv2.resize(frame_aux, (0, 0), fx=1, fy=1)
				...
				try:
					...
					if reference != 0: 
						...
						if time.time() - reference_ct > 1:
							if name not in nomes_IN:
								string_IN.append(name + " - " + str(reference) + "\n")
								nomes_IN.append(name)
				...
				try:
					...
					if reference != 0: 
						...
						if time.time() - reference_ct > 3:
							...
							path1 = '/home/default/Desktop/PDI - Projeto Final/DATA_SET_UNKNOWN' 
							cv2.imwrite(os.path.join(path1,"ID"+"-"+str(cnt)+".jpg"), image_unknown)

							path2 = '/home/default/Desktop/PDI - Projeto Final/DATA_SET_MV'
							cv2.imwrite(os.path.join(path2,"ID" + "-" + str(cnt) + ".jpg"), image_unknown)			
							aux2 = "ID" + "-" + str(cnt) + "-_-"

							dict_[aux2] = face_recognition.load_image_file("/home/default/Desktop/PDI - Projeto Final/DATA_SET_MV/"+"ID"+"-"+str(cnt)+".jpg") 
